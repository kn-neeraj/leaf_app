...
## Purpose
Understand what makes **Bear** a beautiful Markdown editor and extract design lessons to apply to **Leaf**, a macOS Markdown *reader*.

---

## What Bear Is
Bear is a native macOS/iOS Markdown note-taking app known for:
- Exceptional typography
- Minimal, distraction-free UI
- Beautiful live Markdown rendering
- Thoughtful Apple-native polish

It is widely praised for *how it feels to read and write*, not just what it does.

---

## Core Design Principles Behind Bear’s Beauty
...
## One-Line Summary
> Bear is beautiful because it treats Markdown as *literature*, not markup — and designs everything around reading comfort.
